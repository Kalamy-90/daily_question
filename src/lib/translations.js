export const translations = {
  fr: {
    ...
    about: {
      ...
      discordLabel: "Discord Kalamy's Team",
    ...
    support: {
      ...
      crypto: "Faire un don via crypto",
      cryptoTitle: "Faire un don via crypto",
  ...
  en: {
    ...
    sections: {
      ...
      newFeaturesSub: "Discover the latest improvements that make Daily Question even more powerful and easy to use!",
